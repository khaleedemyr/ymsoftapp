  ...
  final List<Map<String, dynamic>> _menuGroupsStructure = [
    {
      ...
      'menus': [
        ...
        {'name': 'PR Assets', 'icon': 'fa-solid fa-boxes-stacked', 'route': '/purchase-requisitions?mode=pr_assets', 'code': 'pr_assets'},
    ...
    },
    {
      ...
      'menus': [
        ...
        {'name': 'Asset Lost & Breakage', 'icon': 'fa-solid fa-exclamation-triangle', 'route': '/lost-breakage', 'code': 'lost_breakage'},
        {'name': 'Asset Replacement', 'icon': 'fa-solid fa-list-check', 'route': '/lost-breakage-replacement-backlog', 'code': 'lost_breakage_replacement_backlog'},
        ...
        {'name': 'Transfer Kepemilikan Aset', 'icon': 'fa-solid fa-people-arrows', 'route': '/asset-owner-transfers', 'code': 'asset_owner_transfer'},
        {'name': 'Asset Stock Adjustment', 'icon': 'fa-solid fa-sliders', 'route': '/asset-inventory-adjustments', 'code': 'asset_stock_adjustment'},
        {'name': 'Asset Repair & Maintenance', 'icon': 'fa-solid fa-screwdriver-wrench', 'route': '/asset-service-orders', 'code': 'asset_service_order'},
        {'name': 'Asset Disposal', 'icon': 'fa-solid fa-dumpster', 'route': '/asset-disposals', 'code': 'asset_disposal'},
        {'name': 'Asset Inventory Report', 'icon': 'fa-solid fa-chart-line', 'route': '/asset-inventory-report', 'code': 'asset_inventory_report'},
        {'name': 'Asset Serial / RFID', 'icon': 'fa-solid fa-nfc-symbol', 'route': '/asset-serials', 'code': 'asset_serial'},
      ],
    },
    {
      'title': 'Master Data',
    ...
    },
    {
      ...
      'menus': [
        ...
        {'name': 'Employee Coaching', 'icon': 'fa-solid fa-user-graduate', 'route': '/employee-coaching', 'code': 'employee_coaching'},
    ...
    },
    {
      ...
      'menus': [
        ...
        {'name': 'Employee Onboarding', 'icon': 'fa-solid fa-user-check', 'route': '/employee-onboarding', 'code': 'employee_onboarding'},
    ...
    },
    {
      ...
      'menus': [
        ...
        {'name': 'Laporan Minus Stock Cut', 'icon': 'fa-solid fa-minus-circle', 'route': '/stock-cut/variance-report', 'code': 'stock_cut_variance_report'},
