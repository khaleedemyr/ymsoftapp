...
class ContraBonApprovalCard extends StatelessWidget {
  final ContraBonApproval approval;
  final VoidCallback onTap;

  const ContraBonApprovalCard({
    super.key,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (approval.sourceType != null) ...[
              const SizedBox(height: 4),
              Text(
                'Source: ${approval.sourceType}',
                style: TextStyle(
                  fontSize: 11,
                  color: Colors.grey.shade600,
                ),
